...
def analysis(filepath):
	...
	elif np.argmax(model_out) == 1: str_label = 'Bacterial \nFor one acre [complex 50kg & urea 50kg, novan 75Ec 250ml, molartonic 250ml in 17:17:17 ratio]'
	elif np.argmax(model_out) == 2: str_label = 'Viral \nFor one acre [complex 50kg & urea 50kg, novan 75Ec 250ml, molartonic 250ml in 15:5:5 ratio]'
	elif np.argmax(model_out) == 3: str_label = 'LEAF blight \nFor one acre [complex 50kg & urea 50kg, magnesium sulphate 25kg, ammonium sulphate 50kg & potash 50 kg in 10:26:26 ratio \nSPRAY:- Chloro freepass 250ml+ Samarus tonic 250ml+  Magnesium 45 500mg+ Magnesium sulphate 0.5kg]'
